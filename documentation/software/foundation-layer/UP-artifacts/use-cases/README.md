...
### UC1.2 - Facebook Authentication

### UC1.3 - OAuth2 Bearer Access Refresh tokens creation

### UC1.4 - Create proper authenticated login HTTP response

### UC1.5 - User registration
...
### UC1.6 - Exchange refresh token for a new access token
